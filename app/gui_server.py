"""FreEco.AI GUI Server

FastAPI backend for the Manus-style GUI interface.
"""
...
app = FastAPI(title="FreEco.AI GUI Server", version="1.0.0")
...
# Mount static files (React build will be here)
try:
    app.mount("/", StaticFiles(directory="app/gui/dist", html=True), name="static")
except Exception:
    print("⚠️  GUI dist folder not found. Frontend not mounted.")
